...
#define NRF_ENABLE()        GPIOB->ODR &= ~(1<<12)
#define NRF_DISABLE()       GPIOB->ODR |= (1<<12)

#define NRF_MODE_READ()     (GPIOD->IDR & (1<<13))

#define NRF_MODE_HIGH()     GPIOD->ODR |= (1<<13)
#define NRF_MODE_LOW()      GPIOD->ODR &= ~(1<<13)
